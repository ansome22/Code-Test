...
class ChargePointAPIView(views.APIView):
    """
    A simple APIView for creating ChargePoint entires.
    """
...
class ConnectorAPIView(views.APIView):
    """
    A simple APIView for creating Connector entires.
    """
...
class RFIDAPIView(views.APIView):
    """
    A simple APIView for creating RFID entires.
    """
    ...
    def post(self, request):
        try:
            data = JSONParser().parse(request)
            serializer = RFIDSerializer(data=data)
            if serializer.is_valid(raise_exception=True):
                serializer.save()
                return Response(serializer.data)
            else:
...
class VehicleAPIView(views.APIView):
    """
    A simple APIView for creating Vehicle entires.
    """
...
class ChargeSessionAPIView(views.APIView):
    """
    A simple APIView for creating Charge Session entires.
    """
